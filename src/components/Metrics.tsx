...
<div className="metric-value" id="m-total">0</div>
...
<div className="metric-value" id="m-active">0</div>
...
<div className="metric-value" id="m-expiring">0</div>
...
<div className="metric-value" id="m-expired">0</div>
...
<div className="metric-value" id="m-dues-val">₹0</div>
<div className="metric-sub" id="m-dues-sub">0 members pending</div>
</div>
...
<div className="metric-value" id="m-bday">0</div>
