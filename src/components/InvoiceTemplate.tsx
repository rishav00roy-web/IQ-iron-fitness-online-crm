...
export default function InvoiceTemplate({ member, currency = "₹" }: { member: any; currency?: string }) {
  ...
  const formatCurrency = (n: number) => {
    const { code, locale } = getCurrencyDetails(currency);
  ...
  return (
    ...
    >
      {/* Page Border (Solid Gold/Amber) */}
      <div
        className="w-full h-full border-[10px] border-[#c8a96a] rounded-sm relative flex flex-col justify-between overflow-hidden bg-white"
        style={{ padding: "24px" }}
      >
        ...
        {/* HEADER SECTION */}
        <div
          className="w-full bg-[#0d1119] text-white p-5 rounded-sm relative overflow-hidden flex items-center justify-between shrink-0 z-10 shadow-md"
          style={{ padding: "20px" }}
        >
          {/* Header background accents */}
          <div
            className="absolute top-0 right-0 w-2/3 h-full bg-[#c8a96a] z-0"
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-slate-400 text-[8px] tracking-[0.2em] font-semibold uppercase mt-1">
                Where Intelligence Meets Iron
              </p>
              <div className="flex gap-0.5 mt-1 text-[#c8a96a] text-[10px]">
          ...
          <div className="relative z-10 flex flex-col items-end gap-2 pr-6" style={{ paddingRight: "24px" }}>
            <div className="bg-[#0d1119] text-[#c8a96a] px-3 py-0.5 font-bold text-[10px] rounded-sm tracking-wider font-display uppercase border border-[#c8a96a]/30">
              TAX INVOICE
            </div>
            <div className="text-right text-[10px] space-y-0.5 font-mono text-slate-300 leading-tight">
              <div>
                Invoice No : <span className="font-bold text-white">{invoiceNumber}</span>
              </div>
              <div>
                Date : <span className="text-white">{invoiceDate}</span>
              </div>
              <div>
        ...
        <div className="grid grid-cols-2 gap-6 my-2 text-[12px] font-body shrink-0 z-10">
          ...
          <div className="bg-slate-50/80 border border-slate-200/60 rounded-md shadow-sm overflow-hidden flex flex-col">
            <div className="bg-[#111722] text-[#c8a96a] px-4 py-1.5 border-b border-[#0d1119]" style={{ padding: "6px 16px" }}>
        ...
        <div className="my-4 shrink-0 z-10">
          <table className="w-full border-collapse border border-slate-200 text-[13px] table-fixed">
            <thead>
              <tr className="bg-[#111722] text-white text-left font-display">
                <th className="py-2.5 px-2 border border-slate-300 w-[6%] text-center" style={{ padding: "10px 8px" }}>
                  #
                </th>
                <th className="py-2.5 px-3 border border-slate-300 w-[44%]" style={{ padding: "10px 12px" }}>
                  DESCRIPTION
                </th>
                <th className="py-2.5 px-2 border border-slate-300 w-[15%] text-center" style={{ padding: "10px 8px" }}>
                  HSN / SAC
                </th>
                <th className="py-2.5 px-2 border border-slate-300 w-[10%] text-center" style={{ padding: "10px 8px" }}>
                  QTY
                </th>
                <th className="py-2.5 px-3 border border-slate-300 w-[12%] text-right" style={{ padding: "10px 12px" }}>
                  UNIT PRICE ({currency})
                </th>
                <th className="py-2.5 px-3 border border-slate-300 w-[13%] text-right" style={{ padding: "10px 12px" }}>
                  AMOUNT ({currency})
                </th>
              </tr>
            </thead>
            <tbody className="text-slate-700 font-medium">
              <tr className="bg-white">
                <td className="py-5 px-2 border border-slate-200 text-center font-mono align-top" style={{ padding: "20px 8px" }}>
                  1
                </td>
        ...
        <div className="grid grid-cols-2 gap-6 my-4 shrink-0 z-10">
          ...
          <div className="border border-slate-200 rounded-md p-4 bg-slate-50/50 flex flex-col justify-between shadow-sm" style={{ padding: "16px" }}>
            <div>
              <h4 className="font-display font-bold text-[11px] uppercase tracking-wider text-[#c8a96a] mb-2.5 pb-1 border-b border-slate-200">
                Payment Methods
              </h4>
              <div className="space-y-2 text-[11px] text-slate-600 leading-relaxed">
                <div className="flex gap-1.5">
                  <span className="font-bold text-[#c8a96a]">UPI :</span>
                  <span>iqironfitness@upi</span>
                </div>
                <div className="space-y-0.5">
                  <p className="font-bold text-[#c8a96a]">Bank Transfer :</p>
          ...
          <div className="space-y-2 text-[12px] font-body">
            ...
            {/* Total Amount Ribbon (Gold background with deep charcoal text) */}
            <div
              className="bg-gradient-to-r from-[#c8a96a] to-[#e2c990] text-[#0a0d15] py-2.5 px-4 rounded-sm flex justify-between items-center shadow-md relative overflow-hidden"
            ...
            <div className="text-[10px] text-slate-500 italic mt-2 leading-snug">
              <span className="font-bold text-slate-700 block not-italic uppercase tracking-wide text-[8px]">
                Amount in Words:
              </span>
              <span>{numberToWords(totalAmount, currency)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 items-end my-3 pt-3 border-t border-slate-200/50 shrink-0 font-body z-10">
          <div className="col-span-2 space-y-1.5">
            <h5 className="font-display font-bold text-[#c8a96a] tracking-wider uppercase text-[9px]">
              Terms & Conditions
            </h5>
          ...
          <div className="flex flex-col items-center justify-end text-center">
            ...
            <div className="w-full border-t border-slate-300 pt-1.5">
              <p className="text-[8px] font-bold text-[#c8a96a] tracking-widest uppercase font-display leading-none">
                Authorised Signatory
              </p>
        ...
        <div className="bg-[#0d1119] border-t border-slate-300 py-3 relative overflow-hidden flex flex-col items-center justify-center shrink-0 w-full mt-3 z-10">
          ...
          {/* Contact Bar */}
          <div className="flex items-center gap-4 text-[9px] text-slate-400 mb-1 font-body justify-center w-full">
            <span>123, Power House Road, Kothrud, Pune - 411038</span>
            <span className="w-0.5 h-0.5 rounded-full bg-[#c8a96a]/50"></span>
          ...
          <div className="flex items-center gap-2">
            ...
            <p
              className="text-white font-display text-[9px] tracking-[0.25em] font-bold uppercase"
