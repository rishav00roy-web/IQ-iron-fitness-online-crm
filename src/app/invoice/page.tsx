...
export const metadata: Metadata = {
  title: 'Invoice | IQ IRON FITNESS',
};

export default function InvoicePage() {
  return (
    <div className="min-h-screen bg-neutral-100 p-4 sm:p-8 flex items-start justify-center font-sans text-neutral-800">
      {/* Invoice Container */}
      <div className="w-full max-w-[1000px] bg-white shadow-2xl overflow-hidden border-[12px] border-slate-200/50 rounded-lg relative">
        ...
        <div className="relative bg-gradient-to-r from-[#031d4f] via-[#0b337c] to-[#031d4f] text-white px-8 pt-8 pb-6 border-b-[8px] border-slate-300">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex-1 text-center flex flex-col items-center">
              <h1 className="text-5xl md:text-6xl font-black tracking-wider text-white drop-shadow-md mb-2" style={{ fontFamily: 'Impact, sans-serif' }}>
                IQ IRON FITNESS
              </h1>
        ...
        <div className="p-8 relative z-10 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 border-2 border-[#e6eaf3] rounded-xl px-6 py-4 bg-white/80 backdrop-blur-sm shadow-sm">
            ...
            <div className="flex items-center gap-4 border-r-2 border-slate-100 pr-8">
              ...
              <div>
                ...
                <p className="font-bold text-slate-800 text-lg">IQIF-2026-0725-0001</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 flex-1 pl-4">
              ...
              <div>
                ...
                <p className="font-bold text-slate-800 text-lg">25 Jul 2026</p>
              </div>
            </div>

            <div className="text-right">
              <p className="text-xs font-bold text-[#0d2a6a] tracking-wider uppercase mb-2">Payment Status</p>
              <div className="bg-[#fb923c] text-white font-bold py-1.5 px-6 rounded-full shadow-md text-sm tracking-wide">
                PARTIALLY PAID
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Member Details */}
            <div className="border-2 border-[#e6eaf3] rounded-xl overflow-hidden bg-white/80 backdrop-blur-sm shadow-sm">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-slate-800 ml-2">Raj Sharma</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center bg-slate-50 text-slate-500">
                  ...
                  <span className="text-slate-400 font-bold">:</span>
                  <span className="font-bold text-slate-800 ml-2">9876543210</span>
                </div>
              </div>
            </div>
            ...
            <div className="border-2 border-[#e6eaf3] rounded-xl overflow-hidden bg-white/80 backdrop-blur-sm shadow-sm">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-slate-400 font-bold">:</span>
                  <span className="font-bold text-slate-800 ml-2">Monthly</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center bg-slate-50 text-slate-500">
                  ...
                  <span className="text-slate-400 font-bold">:</span>
                  <span className="font-bold text-slate-800 ml-2">25 Jul 2026</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center bg-slate-50 text-slate-500">
                    <CalendarDays className="w-4 h-4" />
                  ...
                  <span className="text-slate-400 font-bold">:</span>
                  <span className="font-bold text-slate-800 ml-2">24 Aug 2026</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            {/* Fee Breakdown */}
            <div className="lg:col-span-2 border-2 border-[#e6eaf3] rounded-xl overflow-hidden bg-white/90 backdrop-blur-sm shadow-sm flex flex-col h-full">
              <div className="bg-[#0b337c] px-4 py-2 flex items-center gap-2">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="p-6 space-y-4 font-medium flex-1">
                  <div className="grid grid-cols-4 text-slate-700">
                    <div className="col-span-3">Membership Fee (Monthly)</div>
                ...
                <div className="bg-slate-50 grid grid-cols-4 px-6 py-4 border-t border-slate-200 mt-auto items-center">
                  ...
                  <div className="relative z-10 text-right h-full flex items-center justify-end">
                    ...
                    ></div>
                    <span className="text-white font-bold text-xl relative z-10 mr-2">₹ 1,500.00</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Totals Summary */}
            <div className="lg:col-span-1 border-2 border-[#e6eaf3] rounded-xl bg-white/90 backdrop-blur-sm shadow-sm overflow-hidden flex flex-col h-full divide-y divide-[#e6eaf3]">
              ...
              <div className="p-5 text-center flex flex-col items-center justify-center flex-1">
                ...
                <p className="text-2xl font-black text-[#0d2a6a]">₹ 1,500.00</p>
              </div>
              ...
              <div className="p-5 text-center flex flex-col items-center justify-center flex-1 bg-green-50/50">
                ...
                <p className="text-3xl font-black text-[#16a34a]">₹ 1,000.00</p>
              </div>
              ...
              <div className="p-5 text-center flex flex-col items-center justify-center flex-1 bg-orange-50/50">
                ...
                <p className="text-3xl font-black text-[#ea580c]">₹ 500.00</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            ...
            {/* Notes */}
            <div className="border border-[#e6eaf3] rounded-lg bg-white overflow-hidden shadow-sm relative">
            ...
            {/* Signature */}
            <div className="border border-[#e6eaf3] rounded-lg bg-white overflow-hidden shadow-sm flex flex-col">
              <div className="bg-slate-50 px-4 py-2 border-b border-[#e6eaf3] flex items-center gap-2">
            ...
            <div className="border border-[#e6eaf3] rounded-lg bg-white overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="p-4 text-[10px] text-slate-600 font-medium leading-relaxed">
                <ul className="list-disc list-outside ml-3 space-y-1.5 marker:text-slate-400">
                  <li>This invoice is valid for the membership period mentioned above.</li>
